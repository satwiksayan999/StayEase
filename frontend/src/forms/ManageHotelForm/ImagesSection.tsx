                    ...
                    <div className="grid grid-cols-6 gap-4">
                        ...
                        {existingImageUrls.map((url) => (
                            <div className="relative group">
                                ...
                                <button className="absolute flex inset-0 items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 text-white" onClick={(event) => handleDelete(event , url)}>Delete</button>
                            </div>
