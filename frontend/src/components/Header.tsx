...
const Header = () => {
    ...
    const { isLoggedIn } = useAppContext(); //to show different links when user is logged in 
                ...
                <span className="flex space-x-2">
                    {
                        isLoggedIn ? (
                            ...
                            <Link  to="/sign-in" className="flex bg-white items-center px-3 text-blue-600 font-bold hover:bg-gray-100 hover:text-green-500 ">Sign In</Link>
                        )
                    }
                </span>
            </div>
