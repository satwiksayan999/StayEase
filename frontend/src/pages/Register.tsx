    ...
    return(
        <form className="flex flex-col gap-5" onSubmit={onSubmit} >
            ...
            <div className="flex flex-col md:flex-row gap-5">
                ...
                <label className="text-gray-700 text-sm font-bold flex-1">
                    password 
                    <input type="password" className="border rounded w-full py-1 px-2 font-normal" autoComplete="password" {...register("password" ,{required:"This field is required" , minLength:{ value:6 , message:"password must be atleast 6 char long "}})}></input>
                    {errors.password && (
                ...
                <label className="text-gray-700 text-sm font-bold flex-1">
                    confirm password 
                    <input type="password" className="border rounded w-full py-1 px-2 font-normal" autoComplete="confirm-password" {...register("confirmpassword" , {validate:(val) =>{ 
                           if(!val)
                            {
